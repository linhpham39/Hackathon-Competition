...
const QuizzDetail = () => {
    ...
    const handleAnswerSelect = (selectedAnswer) => {
        ...
        if (selectedAnswer === currentQuestion.correctAns) {
            ...
            setAnswerMessage(`Incorrect. The correct answer is: ${currentQuestion.correctAns}`);
    ...
    const handleQuizCompletion = () => {
        if (correctAnswersCount > 8) {
            return <p className="quizCompletedMessage">Pass the test!</p>;
        } else {
            return <p className="quizCompletedMessage">Quiz completed.</p>;
        }
    };
                ...
                {currentQuestionIndex < questions.length && (
                    <div key={questions[currentQuestionIndex].id} className="questionContainer">
                        ...
                        <p className="explanation">
                            <strong>Explanation:</strong> {questions[currentQuestionIndex].explaination}
                        </p>
                    </div>
                )}
